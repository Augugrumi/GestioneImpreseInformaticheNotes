...
investono e poi ricevono dei soldi indietro\footnote{In questo caso si parlano
...
guadagno dell'investitore è in un'eventuale \textit{exit} dall'azienda.\\[0.3cm]
...
\begin{enumerate}
 ...
 tempi ristretti: un errore di molta start-up è voler uscire con un prodotto
 troppo rifinito per essere un MVP, e ciò richiede troppo tempo per essere
 fatto.
 
 Lo scopo di un MVP è di ottenere feedback dal mercato e se ci sono clienti
 interessati. Ciò è fondamentale in quanto approcciandosi ad aree nuove di
 mercato è importante ottenere delle giuste direzione di mercato. Nel caso in
 cui il mercato indichi che la direzione di mercato scelta è errata è
 necessario fare \textbf{pivoting}, ovvero cambiare la direzione in cui ci si
 stava muovendo. Nel mondo delle start-up è normale che ci siano dei continui
 cambi di direzione: centrare le necessità del business model al primo colpo è
 praticamente impossibile. Spesso se una startup non fa pivoting vuol dire che
 da poca importanza ai feedback del mercato oppure non ne vengono proprio
 raccolti.
 ...
 \todo{Non ha detto nient'altro a riguardo!}
 ...
 anche se possono continuare a essere considerate azionisti di maggioranza.
...
vantaggiosa possono decidere di vendere anche le quote anche dei fondatori che
