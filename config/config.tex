...
% Frontespizio
%**************************************************************
\newcommand{\myName}{Emanuele Carraro, Giacomo Fornari, Lisa Parma, Matteo Di
Pirro, Davide Polonio, Marco Zanella} % autore
...
\newcommand{\mKeywordit}[1]{\textit{\mKeyword{#1}}}
...
%---------------- LIST OF DEFINITIONS AT THE END OF THE CHAPTER -----
\makeatletter
\def\ll@tdefn{%
...
\renewcommand{\listtheoremname}{Elenco delle definizioni}
